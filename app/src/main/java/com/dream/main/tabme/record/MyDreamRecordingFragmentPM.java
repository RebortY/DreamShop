...
import com.dream.bean.MyDreamRecordBean;
import com.dream.bean.MyDreamRecordInfo;
import com.dream.main.DreamApplication;
import com.dream.main.tabshow.CommentItemPM;
...
public class MyDreamRecordingFragmentPM implements HasPresentationModelChangeSupport {
    ...
    private List<MyDreamRecordInfo> data = new ArrayList<>();
    ...
    public void respHandler(NetResponse response) {
        ...
        if (response.getRespType() == NetResponse.SUCCESS) {
            try {
                ...
                List<MyDreamRecordInfo> commentInfos = JSON.parseArray(array.toString(), MyDreamRecordInfo.class);
                data.clear();
    ...
    public List<MyDreamRecordInfo> getData() {
        return data;
    }
}
